...
def find_employee_by_name():
    ...
    print(employee) if employee else print(f'No employee found with name {name}')


def find_employee_by_id():
    id_ = input("Enter employee id: ")
    employee = Employee.find_by_id(id_)
    print(employee) if employee else print(f'No employee found with id of {id_}')
...
def delete_employee():
    ...
    if employee := Employee.find_by_id(id_):
        employee.delete()
        print(f'Employee {id_} terminated')
    else:
        print(f'Employee {id_} not found')
